...
class ManterHorarioUI:
    ...
    def inserir():
        ...
        profissional = st.selectbox("Informe o profissional", View.profissional_listar())
        ...
        if st.button("Inserir"):
            ...
            if profissional:
                View.horario_inserir(data, confirmado, cliente.id, servico.id, profissional.id)
                View.profissional_adicionar_horario(profissional.id, data)
